...
Du kannst Bitcoin nutzen, indem du eine App auf deinem Handy installierst:
...
Es gibt keine Rückbuchungsmöglichkeit, was es insbesondere für Online-Geschäftsmodelle relevant macht.
...
1. Staatliche Zentralbank-Digitalwährungen (CBDC), in denen ich zwei große Gefahren sehe:
    - Falsche wirtschaftliche Anreizsetzung, bedingt durch die [Geldpolitik die damit ermöglicht wird](https://twitter.com/_d11n_/status/1311913535820230658) (Negativzinsen, Helikoptergeld, Verdrängung von Geschäftsbanken und Bargeldabschaffung)
    - Eine totalitärere Politik, welche mit digitaler Zentralbankwährung als einziger Geldform ein wichtiges Instrument für zentrale Steuerung und Überwachung hätte.
...
Beispielsweise Bitcoin Cash (Tickersymbol BCH) ist als Abspaltung vom ursprünglichen Bitcoin entstanden.

Diese sogenannten Forks starteten zwar mit einem Teil der ursprünglichen Bitcoin-Blockchain, zweigen dann aber unwiederbringlich davon ab.
...
Die Erfahrung zeigt, dass die meisten Projekte keine klaren Ziele oder innovative Daseinsberechtigung haben.
...
- 2021: NFTs – Non-Fungible Token, digitale Sammlerstücke, deren Einzigartigkeit und Handel über "Blockchain" gewährleistet wird

Meine persönliche Meinung: Der absolute Großteil der Altcoins und Token-Projekte ist schlichtweg Betrug mit dem Ziel Bitcoins einzusammeln.
