...
In Wallet-Software wie [Sparrow](../sparrow-wallet/) oder auf Geräten wie der BitBox oder [SeedSigner](../seedsigner-hardware/) kannst du einfach neue Accounts hinzufügen.
